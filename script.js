const translations = {
  ...
  project1: {
    en: {
      ...
      meshStudyIntroText: "To assess the mesh sensitivity of the results, three mesh configurations were tested on the V2 geometry. The mesh convergence study was performed on V2 rather than V1, since the sharp edge at the load-application site in V1 produced a stress singularity, creating a non-physical stress concentration that increases indefinitely with mesh refinement.",
      meshTableColMesh: "Mesh",
      meshTableColGlobalSize: "Global Size",
      meshTableColLocalSize: "Local Size",
      meshTableColPeakStress: "Peak Stress",
      meshTableColTotalDeformation: "Total Deformation",
      meshRowCoarse: "Coarse",
      meshRowMedium: "Medium",
      meshRowFine: "Fine",
      meshStudyConclusionText: "A stress sensitivity of ~8.5% was observed between the medium and fine mesh configurations in V2. Since the primary V1 and V2 analyses were performed using identical mesh settings, the baseline-to-optimized comparison was carried out on a consistent numerical basis. The supplementary mesh sensitivity check also showed that V2 produced a more stable stress response under refinement than the singularity-prone V1 geometry. Total deformation showed good convergence across all three configurations, with a variation below 5%.",
