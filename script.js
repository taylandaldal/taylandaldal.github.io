const translations = {
  index: {
    en: {
      ...
      heroRole: "Mechanical Engineer | CAE & CAD",
      heroSub: "FEA | Ansys | SolidWorks | Engineering Analysis | Design Iteration | Optimization | Automation | Robotics",
      ...
      aboutTitle: "About",
      aboutText: "Mechanical engineer focused on CAE, engineering analysis, and mechanical design. This portfolio showcases selected independent engineering projects involving FEA, simulation, optimization, and design iteration, with applications in manufacturing, automation, and robotics. The projects include structural, fatigue, modal, buckling, and thermo-mechanical analyses, as well as topology optimization.",

      skillsTitle: "Skills",
      toolsTitle: "Tools",
      coreTitle: "Core Areas",
      relatedTitle: "Related Areas",
      skillSolidWorks: "SolidWorks",
      skillAnsys: "Ansys",
      skillCAE: "CAE",
      skillFEA: "FEA",
      skillMechanicalDesign: "Mechanical Design",
      skillEngineeringAnalysis: "Engineering Analysis",
      skillOptimization: "Optimization",
      skillManufacturing: "Manufacturing",
    ...
    de: {
      heroTitle: "Taylan Daldal",
      heroRole: "Maschinenbauingenieur | CAE & CAD",
      heroSub: "FEM | Ansys | SolidWorks | Ingenieurtechnische Analyse | Designiteration | Optimierung | Automatisierung | Robotik",
      ...
      aboutText: "Maschinenbauingenieur mit Schwerpunkt auf CAE, ingenieurtechnischer Analyse und mechanischer Konstruktion. Dieses Portfolio zeigt ausgewählte unabhängige Engineering-Projekte mit FEA, Simulation, Optimierung und Designiteration, mit Anwendungen in Fertigung, Automatisierung und Robotik. Die Projekte umfassen strukturelle, Ermüdungs-, Modal-, Knick- und thermomechanische Analysen sowie Topologieoptimierung.",
      ...
      skillCAE: "CAE",
      skillFEA: "FEM",
      skillMechanicalDesign: "Maschinenbau-Konstruktion",
      skillEngineeringAnalysis: "Ingenieurtechnische Analyse",
      skillOptimization: "Optimierung",
      skillManufacturing: "Fertigung",
      skillAutomation: "Automatisierung",
      skillRobotics: "Robotik",
